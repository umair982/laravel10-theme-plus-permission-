        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Admin List</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
...
<path opacity="0.5" d="M9 4C9 3.44772 9.44772 3 10 3H14C14.5523 3 15 3.44772 15 4V4H9V4Z" fill="currentColor"/>
                ...
                <div class="card-body pt-0">
                    ...
                    <form action="{{route('delete-selected-admins')}}" method="post" id="client_form">
...
@section("scripts")
    ...
    <script>
        ...
        function viewInfo(id) {
            ...
            $.post("{{ route('admin.getAdmin') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    var APP_URL = {!! json_encode(url('/')) !!}
                        window.location.href = APP_URL+"/admin/admin/delete/"+id;
                }
            });
        }
