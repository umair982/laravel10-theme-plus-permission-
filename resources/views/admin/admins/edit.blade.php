                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            <!--begin::Form-->
                            {{ Form::model($admin, [ 'method' => 'PATCH','route' => ['admins.update', $admin->id],'class'=>'form' ,"id"=>"client_update_form", 'enctype'=>'multipart/form-data'])}}
                            @csrf
                                <!--begin::Input group-->
...
{{--                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter the contact's company name (optional)."></i>--}}
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input" name="active" type="checkbox" @if($admin->active) checked @endif value="1" id="flexCheckDefault"/>
                        ...
                        <div class="row">
                            ...
                            <!--end::Input group-->
                                ...
                                <div class="d-flex justify-content-end">
                                    <!--begin::Button-->
                                    <a href="{{route("admins.index")}}"  class="btn btn-light me-3">Back</a>
                                    <!--end::Button-->
                                    <!--begin::Button-->
