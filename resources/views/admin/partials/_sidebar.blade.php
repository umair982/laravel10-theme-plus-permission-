...
{{--                <!--end:Menu item-->--}}
                ...
                <a href="{{route("roles.index")}}"
                   class="menu-item @if(Request::segment(1) == 'admin' && Request::segment(2) == 'roles') here @endif">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                ...
                <!--end:Menu item-->
                 ...
                 class="menu-item @if(Request::segment(1) == 'admin' && Request::segment(2) == 'admins') here @endif">
                  <!--begin:Menu link-->
                  <span class="menu-link">
                          <span class="menu-icon">
                              <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
