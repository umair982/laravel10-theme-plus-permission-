...
class SettingController extends Controller
{
    ...
    {
        $this->middleware('permission:setting-list|setting-create|setting-edit|setting-delete', ['only' => ['index','show']]); //to access index and show function atleat one of mentioned permission should be assigned
